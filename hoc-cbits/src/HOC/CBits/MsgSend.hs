...
foreign import ccall "&objc_msgSend"
    objc_msgSendPtr :: FunPtr (Ptr ObjCObject -> SEL a -> a)
foreign import ccall "&objc_msgSend_stret"
    objc_msgSend_stretPtr :: FunPtr (Ptr ObjCObject -> SEL a -> a)

foreign import ccall "&objc_msgSendSuper"
    objc_msgSendSuperPtr :: FunPtr (Ptr ObjCObject -> SEL a -> a)
foreign import ccall "&objc_msgSendSuper_stret"
